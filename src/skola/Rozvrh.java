...
public class Rozvrh
{
    ...
    {
        StringBuilder b = new StringBuilder(Nahrada.paddRight("Den",' ',sirkaSloupce)).append(sep);
        for (int k = 0; k < 15; k++)
            b.append(Nahrada.paddRight(casy.get(k).toString(),' ',sirkaSloupce)).append(sep);
    ...
    {
        StringBuilder b = new StringBuilder(Nahrada.paddRight("",'_',sirkaSloupce)).append(sep);
        for (int k = 0; k < 15; k++)
           b.append(Nahrada.paddRight("",'_',sirkaSloupce)).append(sep);
    ...
    public String radekTabulky(int i, int sirkaSloupce, String sep)
    {
        ...
        b[0] = new StringBuilder(Nahrada.paddRight(Dny.Jmeno(i),' ',sirkaSloupce)).append(sep);
        b[1] = new StringBuilder(Nahrada.paddRight("",' ',sirkaSloupce)).append(sep);
        b[2] = new StringBuilder(Nahrada.paddRight("",'_',sirkaSloupce)).append(sep);
        ...
        for (int k = 0; k < 15; k++)
        {
            ...
            if (akce == null)
            {
                b[0].append(Nahrada.paddRight("",' ',sirkaSloupce)).append(sep);
                b[1].append(Nahrada.paddRight("",' ',sirkaSloupce)).append(sep);
                b[2].append(Nahrada.paddRight("",'_',sirkaSloupce)).append(sep);
            }
            else
                if (k == akce.getZacatek())
                {
                    int len = akce.delka();
                    b[0].append(Nahrada.paddBetween(akce.getPredmet().toString(), akce.getTyp().substring(0,2), ' ', len*sirkaSloupce + len-1)).append(sep);
                    b[1].append(Nahrada.paddBetween(akce.getUcebna().toString(), akce.getUcitel().toString(), ' ', len*sirkaSloupce + len-1)).append(sep);
                    b[2].append(Nahrada.paddRight("",'_',len*sirkaSloupce + len-1)).append(sep);
                }
        }
